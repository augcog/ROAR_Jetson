...
volatile uint32_t controller_throttle_read = 0;
volatile uint32_t controller_steering_read = 0;
...
void loop() {
  ...
  rc_controller_state = determineTraxxasControllerConnected(); // true if connected, false otherwise ( 0 == true, 1 == false)
